...
(0, _enterView2.default)({
  ...
  enter: function enter(element) {
    element.classList.add('entered'); // Trigger stepin for current step

    d3.select(element).dispatch('stepin');
  },
  exit: function exit(element) {
    element.classList.remove('entered'); // Trigger stepout for current step

    d3.select(element).dispatch('stepout'); // Trigger stepin for previous step (if it exists)
...
},{"enter-view":"../node_modules/enter-view/enter-view.min.js","d3":"../node_modules/d3/index.js"}],"../../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../.npm-global/lib/node_modules/parcel/src/builtins/hmr-runtime.js","scrollytelling.js"], null)
//# sourceMappingURL=/scrollytelling.74c0b9bd.map